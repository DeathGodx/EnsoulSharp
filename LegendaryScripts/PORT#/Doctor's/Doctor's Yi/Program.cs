...
namespace Yi
{
    class Program
    {
        ...
        private static void OnLoadingComplete()
        {
            ...
            Chat.Print("Doctor's Yi Loaded! Ported By DEATHGODX", Color.Orange);
            Bootstrap.Init(null);
        ...
        public static void Combo()
        {
            ...
            if (target != null)
            {
                ...
                if (useR && R.IsReady() && (_Player.Position.CountEnemyHeroesInRange(675) >= MinR || Player.Instance.HealthPercent <= 30))
                {
                    R.Cast();
                }
        ...
        public static void KillSteal()
        {
            ...
            foreach (var target in GameObjects.EnemyHeroes.Where(e => e.IsValidTarget(Q.Range) && !e.HasBuff("JudicatorIntervention") && !e.HasBuff("kindredrnodeathbuff") && !e.HasBuff("Undying Rage") && !e.IsDead && !e.IsZombie))
            {
