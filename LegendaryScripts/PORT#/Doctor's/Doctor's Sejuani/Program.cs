...
namespace Sejuani7
{
    internal class Program
    {
        ...
        private static void Game_OnUpdate(EventArgs args)
        {
            ...
            {
                Player.IssueOrder(GameObjectOrder.MoveTo, Game.CursorPosCenter); //hata verirse Cursoru sil
            }
        }
        ...
        private static void FlashQ()
        {
            ...
            if (targetF != null)
            {
                ...
                {
                    Player.CastSpell(_Player.GetSpellSlot("summonerflash"), targetF.Position);
                }
            }
        }
        ...
        private static void LaneClear()
        {
            ...
            var minion = GameObjects.EnemyMinions.Where(a => a.Distance(Player.Instance) <= E.Range).OrderBy(a => a.Health).FirstOrDefault();
